...
- **Technologies:** ASP.NET Core 8.0, C#, Entity Framework Core 8, Dapper, PostgreSQL, React, TypeScript, Tailwind CSS, Chart.js, Hangfire, Redis, Serilog
...
## OMD Planning & Reporting Interface Project (08/2025 - 09/2025)
- **Technologies:** .NET Framework, C#, MSSQL, Vue, echart
- **Description:** Developed a planning and reporting interface system for Optical  Module Divisiob (OMD). The system enables production planning, resource allocation, and comprehensive reporting capabilities with interactive data visualization to support data-driven decision making.
- **Location:** Applied Optoelectronics Inc

## WMS IQC Interface integreting with SAP (7월)
- **Technologies:** .NET Framework, C#, MSSQL, Vue, echart
- **Description:** Developed an interface system to integrate Warehouse Management System (WMS) Incoming Quality Control (IQC) processes with SAP. The system automates the inventory confirmation workflow for incoming materials, enabling seamless data synchronization between WMS and SAP ERP systems.
- **Location:** Applied Optoelectronics Inc

## RealEstate Rental Web Application (03/2025 - 05/2025)
- **Technologies:** Next.js, React, TypeScript, Tailwind CSS, AWS, Supabase(PostgreSQL)
- **Description:** Developed a web platform designed to help real estate investors identify and evaluate potential investment properties. The application collects real estate data from external APIs including Zillow and Redfin, and utilizes machine learning models to estimate appropriate rental rates and property values. The platform provides comprehensive property listings with detailed financial metrics, investment analysis tools, search and filtering capabilities based on investment criteria, and predictive analytics to assist investors in making informed investment decisions.
- **Location:** University of Massachusetts Boston

## Professor Search Web Application (09/2024 - 02/2025)
- **Technologies:** Next.js, React, TypeScript, Tailwind CSS, AWS, Supabase(PostgreSQL)
- **Description:** Developed a matching platform that connects students seeking research labs with professors looking for students, based on research topics and interests. The application utilizes machine learning clustering techniques to analyze and visualize research interests as graphs, which are then used to facilitate intelligent matching between students and professors with compatible research focuses.
- **Location:** University of Massachusetts Boston
